...
<head>
    ...
    <title>{{ $title }} | CV ARGBISNIS</title>
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-info">
        ...
        <a class="navbar-brand ps-3" href="/home">
            <img src="{{ asset('img/pupuk.png') }}" class="rounded-circle" width="40px"> CV AGRIBISNIS
        </a>
        <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-succes" style="background-color: rgb(142, 202, 30)"id="sidenavAccordion">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy;2023 by Muhammad Naufal Fathin Hibrizi</div>
                    </div>
                </div>
            </footer>
        </div>
